...
*第十六章*，*Zapier 中的文本格式化功能 - 第 1 部分*，描述了可用于格式化文本的广泛功能。我们涵盖了一系列文本格式化操作，如将文本大写化和复数化；应用标题格式、大写格式和小写格式；查找和替换文本；修剪空白字符；以及计算字符和单词数。

*第十七章*，*Zapier 中的文本格式化功能 - 第 2 部分*，涵盖了更多可用于格式化文本的功能。我们探讨了如何拆分和截断文本；删除 HTML；分配默认值；提取模式、URL 和电子邮件地址等数据；以及使用超级英雄名称。我们还简要介绍了更高级的文本操作功能，如如何将 Markdown 转换为 HTML、URL 编码和解码以及将文本转换为 ASCII。
...
**一般反馈**：如果您对本书的任何方面有疑问，请给我们发送电子邮件至 customercare@packtpub.com，并在您消息的主题中提到书名。

**勘误**：尽管我们已竭尽全力确保内容的准确性，但错误难免发生。如果您在本书中发现错误，请向我们报告。请访问[www.packtpub.com/support/errata](https://www.packtpub.com/support/errata)并填写表格。

**盗版**：如果您在互联网上发现我们作品的任何形式的非法拷贝，我们将不胜感激地为我们提供位置地址或网站名称。请通过 copyright@packtpub.com 联系我们并附上材料链接。

**如果你对成为作者感兴趣**：如果你在某个专题上有专业知识，并且对撰写或贡献书籍感兴趣，请访问[authors.packtpub.com](https://authors.packtpub.com)。

# 分享你的想法

当你阅读完*《使用 Zapier 和生成式 AI 自动化》*的第二版后，我们很想听听你的想法！请[点击这里直接转到亚马逊评论页面](https://packt.link/r/1-803-23984-0)给这本书分享你的反馈。

你的评论对我们和技术社区至关重要，它将帮助我们确保我们提供的内容质量卓越。
...
别担心，现在每买一本 Packt 的书，你都会免费得到一份无 DRM 的 PDF 版本。

随时随地、任何地方、任何设备上阅读。直接从你最喜爱的技术书籍中搜索、复制和粘贴代码到你的应用程序中。

好处不止于此，你还可以在每天的收件箱里获得独家折扣、新闻简报和优质免费内容。

遵循以下简单步骤获取好处：

1.  扫描下方的 QR 码或访问下面的链接

![](img/B18474_QR_Free_PDF.jpg)

[`packt.link/free-ebook/9781803239842`](https://packt.link/free-ebook/9781803239842)

1.  提交你的购买凭证

1.  就是这样！我们将把你的免费 PDF 和其他好处直接发送到你的邮箱。
