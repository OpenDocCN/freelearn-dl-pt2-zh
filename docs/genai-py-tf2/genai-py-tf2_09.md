...
我们非常清楚神经网络的深度在处理计算机视觉任务时如何帮助其学习复杂和抽象的概念。同样，一个堆叠的 LSTM 架构，它有多个 LSTMs 层依次堆叠在一起，已经被证明能够带来相当大的改进。堆叠的 LSTMs 首次由格雷夫斯等人在他们的工作中提出*使用深度循环神经网络进行语音识别*⁶。他们强调了深度-多层 RNNs-与每层单位数目相比，对性能的影响更大。
...
1.  Graves, A., Mohamed, A., & Hinton, G. (2013). *深度循环神经网络语音识别*. arXiv. [`arxiv.org/abs/1303.5778`](https://arxiv.org/abs/1303.5778)
